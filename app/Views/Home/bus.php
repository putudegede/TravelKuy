  ...
  <div class="row">
    <div class="col-4">
      <div class="card-body p-0">
        <form action="<?= base_url('Home/tiketBus'); ?>" method="post">
          <div class="item form-group">
            <label for="kotaAsal">Kota Asal</label>
            <div class="input-group mb-3">
              <select class="custom-select" name="kotaAsal" id="kotaAsal" onchange="terminal()" required>
                <option value=" ">-Pilih Kota-</option>
                <option value="Terminal Bungurasih">Surabaya</option>
                <option value="Terminal Pasar Rebo">Jakarta</option>
              </select>
            </div>
          </div>
          <div class="item form-group">
            <label for="terminalAsal">Terminal Keberangkatan</label>
            <div class="input-group mb-3">
              <input type="text" class="form-control" name="terminalAsal" id="terminalAsal" readonly>
              <script type="text/javascript">
                function terminal() {
                  var data = document.getElementById("kotaAsal").value;
                  document.getElementById("terminalAsal").value = data;
                }
              </script>
            </div>
          </div>
          <div class="item form-group">
            ...
            <div class="input-group mb-3">
              <select class="custom-select" name="kotaTujuan" id="kotaTujuan" onchange="terminalTujuan()" required>
                <option value=" ">-Pilih Kota-</option>
                <option value="Terminal Bungurasih">Surabaya</option>
                <option value="Terminal Pasar Rebo">Jakarta</option>
              </select>
          ...
          <div class="item form-group">
            <label for="terminalTiba">Tiba Di Terminal</label>
            <div class="input-group mb-3">
              <input type="text" class="form-control" name="terminalTiba" id="terminalTiba" readonly>
              <script type="text/javascript">
                function terminalTujuan() {
                  var data = document.getElementById("kotaTujuan").value;
                  document.getElementById("terminalTiba").value = data;
                }
              </script>
            </div>
          </div>
          ...
          <div class="item form-group">
            <label for="tipeKursi">PIlih Maskapai</label>
            <div class="input-group mb-3">
              <select class="custom-select" name="tipeKursi" id="tipeKursi" onchange="hargaPesawat()" required>
                <option value=" ">-Pilih Maskapai-</option>
                <option value="100000">Sumber Brantas</option>
                <option value="100800">Akas Indonesia</option>
                <option value="120000">Kalisari</option>
                <option value="150000">Sumber Kencono</option>
              </select>
            </div>
          </div>
          <div class="item form-group">
